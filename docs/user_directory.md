...
* `user_directory_stream_pos`. When the initial background update to populate
  ...
  that relapse should now listen for room changes and incrementally update
  the directory where necessary. (See [stream positions](development/relapse_architecture/streams.html).)
