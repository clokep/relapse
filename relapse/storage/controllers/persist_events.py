...
from relapse.storage.controllers.state import StateStorageController
from relapse.storage.databases import Databases
from relapse.storage.databases.main.events import DeltaState
...
from relapse.util.async_helpers import ObservableDeferred, yieldable_gather_results
...
state_delta_counter = Counter("relapse_storage_events_state_delta", "")

# The number of times we are recalculating state when there is only a
# single forward extremity
state_delta_single_event_counter = Counter(
    "relapse_storage_events_state_delta_single_event", ""
)
...
state_delta_reuse_delta_counter = Counter(
    "relapse_storage_events_state_delta_reuse_delta", ""
)

# The number of forward extremities for each new event.
forward_extremities_counter = Histogram(
    "relapse_storage_events_forward_extremities_persisted",
