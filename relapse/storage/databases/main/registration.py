...
from relapse.storage.util.id_generators import IdGenerator
...
class RegistrationWorkerStore(CacheInvalidationWorkerStore):
    ...
    async def set_user_type(self, user: UserID, user_type: UserTypes | None) -> None:
        """Sets the user type.
    ...
    def _record_user_external_id_txn(
        ...
        against configured IdPs as Relapse does not know its relationship to
    ...
    async def generate_registration_token(self, length: int, chars: str) -> str | None:
        ...
        Raises:
            RelapseError if a unique registration token could still not be
