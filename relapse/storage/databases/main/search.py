...
class SearchBackgroundUpdateStore(SearchWorkerStore):
    ...
    async def _background_reindex_gin_search(
        ...
        """This handles old relapses which used GIST indexes, if any;
    ...
    async def _background_delete_non_strings(
        ...
        Prior to Relapse 1.44.0, malformed events received over federation could cause integers
    ...
    async def search_rooms(
        ...
        if pagination_token:
            try:
                ...
                raise RelapseError(400, "Invalid pagination token")
