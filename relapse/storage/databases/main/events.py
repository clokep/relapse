...
from relapse.api.constants import EventContentFields, EventTypes, RelationTypes
from relapse.api.errors import PartialStateConflictError
...
from relapse.storage._base import db_to_json, make_in_list_sql_clause
...
from relapse.storage.databases.main.search import SearchEntry
from relapse.storage.engines import PostgresEngine
from relapse.storage.util.id_generators import AbstractStreamIdGenerator
from relapse.storage.util.sequence import SequenceGenerator
from relapse.types import JsonDict, StateMap, StrCollection, get_domain_from_id
from relapse.util import json_encoder
from relapse.util.iterutils import batch_iter, sorted_topologically
from relapse.util.stringutils import non_null_str_or_none
...
persist_event_counter = Counter("relapse_storage_events_persisted_events", "")
event_counter = Counter(
    "relapse_storage_events_persisted_events_sep",
    "",
...
class PersistEventsStore:
        ...
        *,
        ...
        async with stream_ordering_manager as stream_orderings:
            ...
            if not use_negative_stream_ordering:
                ...
                # stream_ordering.
                relapse.metrics.event_persisted_position.set(stream)
    ...
    def _persist_transaction_ids_txn(
        ...
        # Relapse relies on the device_id to scope transactions for events..
    ...
    def _set_push_actions_for_event_and_users_txn(
        ...
        sql = """
            INSERT INTO event_push_actions (
                ...
                topological_ordering, notif, highlight, thread_id
            )
            SELECT ?, event_id, user_id, actions, ?, ?, notif, highlight, thread_id
