...
from relapse.replication.tcp.streams._base import DeviceListsStream
...
from relapse.storage.databases.main.end_to_end_keys import EndToEndKeyWorkerStore
...
from relapse.util.caches.stream_change_cache import (
...
class DeviceWorkerStore(RoomMemberWorkerStore, EndToEndKeyWorkerStore):
    ...
    async def get_device(self, user_id: str, device_id: str) -> dict[str, Any] | None:
