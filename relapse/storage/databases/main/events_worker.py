...
from relapse.api.constants import Direction, EventTypes
...
from relapse.events.utils import prune_event
from relapse.logging.context import (
    PreserveLoggingContext,
    current_context,
    make_deferred_yieldable,
)
from relapse.logging.opentracing import start_active_span, tag_args, trace
from relapse.metrics.background_process_metrics import (
    run_as_background_process,
    wrap_as_background_process,
)
from relapse.replication.tcp.streams import BackfillStream, UnPartialStatedEventStream
from relapse.replication.tcp.streams.events import EventsStream
from relapse.replication.tcp.streams.partial_state import UnPartialStatedEventStreamRow
from relapse.storage._base import SQLBaseStore, db_to_json, make_in_list_sql_clause
...
from relapse.storage.util.sequence import build_sequence_generator
    ...
    async def _get_events_from_db(
        ...
        for event_id, row in fetched_events.items():
            ...
            if original_ev.event_id != event_id:
                ...
                # if Relapse cannot rely on the consistency of its database.
                raise RuntimeError(
