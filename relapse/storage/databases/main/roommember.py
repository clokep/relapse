...
from relapse.storage.engines import Sqlite3Engine
from relapse.storage.roommember import (
...
class RoomMemberWorkerStore(EventsWorkerStore, CacheInvalidationWorkerStore):
    def __init__(
        ...
        if (
            ...
            LaterGauge(
                "relapse_federation_known_servers",
                "",
                [],
    ...
    async def _count_known_servers(self) -> int:
        ...
        `relapse_federation_known_servers` LaterGauge to collect.
        """
    ...
    @cached(max_entries=100000)  # type: ignore[relapse-@cached-mutable]
    ...
    async def get_rooms_for_local_user_where_membership_is(
        ...
        Args:
            user_id: The user ID.
            membership_list: A list of relapse.api.constants.Membership
    ...
    @cached(max_entries=10000)  # type: ignore[relapse-@cached-mutable]
