...
from relapse.api.constants import MAIN_TIMELINE, ReceiptTypes
...
class EventPushActionsWorkerStore(ReceiptsWorkerStore, StreamWorkerStore, SQLBaseStore):
    ...
    @cached(tree=True, max_entries=5000, iterable=True)  # type: ignore[relapse-@cached-mutable]
    ...
    def _get_unread_counts_by_pos_txn(
        ...
        # (as the row was written by an older version of Relapse that
