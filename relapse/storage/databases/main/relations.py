...
from relapse.api.constants import MAIN_TIMELINE, Direction, RelationTypes
...
from relapse.storage.databases.main.stream import (
    generate_next_token,
    generate_pagination_bounds,
    generate_pagination_where_clause,
)
from relapse.storage.engines import PostgresEngine
from relapse.types import JsonDict, MultiWriterStreamToken, StreamKeyType, StreamToken
...
class ThreadsNextBatch:
    ...
    def from_string(cls, string: str) -> "ThreadsNextBatch":
        ...
        try:
            ...
            raise RelapseError(400, "Invalid threads token")
