...
from relapse.replication.tcp.streams.partial_state import UnPartialStatedRoomStream
...
from relapse.types import JsonDict, RetentionPolicy, StrCollection, ThirdPartyInstanceID
from relapse.util import json_encoder
from relapse.util.caches.descriptors import cached, cachedList
from relapse.util.stringutils import MXC_REGEX
...
class RoomBackgroundUpdateStore(SQLBaseStore):
    ...
    def set_room_is_public(self, room_id: str, is_public: bool) -> Awaitable[None]:
        ...
        #
        # It's overridden by RoomStore for the relapse master.
