...
from relapse.api.constants import MAX_DEPTH
from relapse.api.errors import StoreError
from relapse.api.room_versions import EventFormatVersions, RoomVersion
...
from relapse.storage.background_updates import ForeignKeyConstraint
...
from relapse.util.caches.descriptors import cached
...
class EventFederationWorkerStore(SignatureWorkerStore, EventsWorkerStore, SQLBaseStore):
    ...
    def _fixup_auth_chain_difference_sets(
        ...
        # `relapse.state.v2_get_auth_chain_difference`. We uses the observation
