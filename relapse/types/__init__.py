...
if TYPE_CHECKING:
    ...
    from relapse.appservice.api import ApplicationService
    from relapse.storage.databases.main import DataStore, PurgeEventsStore
...
class IRelapseReactor(
    ...
    """The interfaces necessary for Relapse to function."""
...
class StreamToken:
    ...
    async def from_string(cls, store: "DataStore", string: str) -> "StreamToken":
        ...
        try:
            ...
            raise RelapseError(400, "Invalid stream token")
