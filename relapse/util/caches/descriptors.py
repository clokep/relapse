...
from relapse.logging.context import make_deferred_yieldable, preserve_fn
...
class CachedFunction(Generic[F]):
    ...
    # Note: This function signature is actually fiddled with by the relapse mypy
...
class DeferredCacheDescriptor(_CacheDescriptorBase):
    ...
    def __get__(
        self, obj: Any | None, owner: type | None
