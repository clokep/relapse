...
from relapse.util.async_helpers import AbstractObservableDeferred, ObservableDeferred
from relapse.util.caches import EvictionReason, register_cache
...
class ResponseCache(Generic[KV]):
    ...
    def _set(
        ...
        *deferred* should run its callbacks in the sentinel logcontext (ie,
        you should wrap normal relapse deferreds with
        relapse.logging.context.run_in_background).
    ...
    async def wrap(
        ...
        **kwargs: Any,
        ...
        follow the relapse logcontext rules and returns it.

        Otherwise, makes a call to *callback(*args, **kwargs)*, which should
        follow the relapse logcontext rules, and adds the result to the cache.
