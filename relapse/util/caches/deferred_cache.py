...
cache_pending_metric = Gauge(
    "relapse_util_caches_cache_pending",
...
class DeferredCache(Generic[KT, VT]):
    ...
    def get(
        ...
        For symmetry with set(), this method does *not* follow the relapse logcontext
    ...
    def set(
        ...
        *original* `value`, (c) any future calls to `get()` will complete with the
        ...
        It is expected that `value` does *not* follow the relapse logcontext rules - ie,
