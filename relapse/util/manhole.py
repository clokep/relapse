...
from relapse.config.server import ManholeConfig
...
def manhole(settings: ManholeConfig, globals: Dict[str, Any]) -> ServerFactory:
    ...
    rlm.chainedProtocolFactory = lambda: insults.ServerProtocol(  # type: ignore[misc,assignment]
        RelapseManhole, dict(globals, __name__="__console__")
    )
...
class RelapseManhole(ColoredManhole):
    ...
    def connectionMade(self) -> None:
        ...
        self.interpreter = RelapseManholeInterpreter(self, self.namespace)
