...
from relapse.metrics import InFlightGauge
from relapse.util import Clock

logger = logging.getLogger(__name__)

block_counter = Counter("relapse_util_metrics_block_count", "", ["block_name"])
...
block_db_txn_duration = Counter(
    "relapse_util_metrics_block_db_txn_duration_seconds", "", ["block_name"]
)

# seconds spent waiting for a db connection, in this block
block_db_sched_duration = Counter(
    "relapse_util_metrics_block_db_sched_duration_seconds", "", ["block_name"]
)
...
in_flight: InFlightGauge[_InFlightMetric] = InFlightGauge(
    "relapse_util_metrics_block_in_flight",
    "",
    labels=["block_name"],
