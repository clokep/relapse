...
from relapse.metrics import Histogram, LaterGauge
...
LaterGauge(
    "relapse_rate_limit_sleep_affected_hosts",
...
LaterGauge(
    "relapse_rate_limit_reject_affected_hosts",
