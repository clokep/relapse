...
from relapse.api.filtering import FilterCollection
...
from relapse.storage.databases.main.event_push_actions import RoomNotifCounts
...
non_empty_sync_counter = Counter(
    "relapse_handlers_sync_nonempty_total",
...
class SyncHandler:
    ...
    async def current_sync_for_user(
        ...
        with start_active_span("sync.current_sync_for_user"):
            ...
            set_tag(RelapseTags.SYNC_RESULT, bool(sync_result))
            return sync_result
    ...
    async def _generate_room_entry(
        ...
        with start_active_span("sync.generate_room_entry"):
            ...
            # tag was added by relapse e.g. for server notice rooms.
            if full_state:
                user_id = sync_result_builder.sync_config.user.to_string()
