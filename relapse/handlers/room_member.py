...
from relapse.event_auth import get_named_level, get_power_level_event
from relapse.events import EventBase
from relapse.events.snapshot import EventContext
from relapse.handlers.pagination import PURGE_ROOM_ACTION_NAME
from relapse.handlers.profile import MAX_AVATAR_URL_LEN, MAX_DISPLAYNAME_LEN
from relapse.handlers.state_deltas import MatchChange, StateDeltasHandler
...
class NoKnownServersError(RelapseError):
...
class RoomMemberHandler(metaclass=abc.ABCMeta):
    ...
    async def update_membership(
        ...
        Params:
            ...
            action: The membership change, see relapse.api.constants.Membership.
    ...
    async def update_membership_locked(
        ...
        if effective_membership_state == Membership.INVITE:
            ...
            block_invite_result: Optional[tuple[Codes, dict]] = None
        ...
        if effective_membership_state == Membership.JOIN:
            ...
            if not is_host_in_room:
                ...
                if not current_membership_type or not current_membership_event_id:
                    ...
                    raise RelapseError(404, "Not a known room")
    ...
    async def send_membership_event(
        ...
        Raises:
            RelapseError if there was a problem changing the membership.
    ...
    async def lookup_room_alias(
        ...
        Raises:
            RelapseError if room alias could not be found.
        """
        directory_handler = self.directory_handler
        mapping = await directory_handler.get_association(room_alias)

        if not mapping:
            raise RelapseError(404, "No such room alias")
