...
from relapse.types import JsonDict, Requester, StreamKeyType, UserID, get_domain_from_id
...
class DeviceMessageHandler:
    def __init__(self, hs: "HomeServer"):
        ...
        # `relapse.app.generic_worker.FederationSenderHandler` when it sees it
