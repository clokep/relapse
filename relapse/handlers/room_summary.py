...
from relapse.types import JsonDict, Requester, StrCollection
...
class RoomSummaryHandler:
    ...
    def __init__(self, hs: "HomeServer"):
        ...
        self._pagination_response_cache: ResponseCache[
            tuple[str, str, bool, int | None, int | None, str | None]
        ] = ResponseCache(
            hs.get_clock(),
            "get_room_hierarchy",
        )
    ...
    async def _get_room_hierarchy(
        ...
        if from_token:
            try:
                ...
                raise RelapseError(400, "Unknown pagination token", Codes.INVALID_PARAM)
    ...
    async def get_room_summary(
        ...
        if is_in_room:
            ...
            if remote_room_hosts is None:
                raise RelapseError(400, "Missing via to query remote room")
