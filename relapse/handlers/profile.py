...
class ProfileHandler:
    ...
    async def get_profile(self, user_id: str, ignore_backoff: bool = True) -> JsonDict:
        ...
        if self.hs.is_mine(target_user):
            ...
            if profileinfo.display_name is None and profileinfo.avatar_url is None:
                raise RelapseError(404, "Profile was not found", Codes.NOT_FOUND)
            ...
            try:
                ...
                raise RelapseError(502, "Failed to fetch profile") from e
    ...
    async def check_profile_query_allowed(
        ...
        Raises:
            RelapseError(403): The two users share no room, or ne user couldn't
        ...
        try:
            ...
            if requester_rooms.isdisjoint(target_user_rooms):
                raise RelapseError(403, "Profile isn't available", Codes.FORBIDDEN)
        except StoreError as e:
            if e.code == 404:
