...
from relapse.api.constants import EventTypes, HistoryVisibility, JoinRules, Membership
...
from relapse.storage.databases.main.user_directory import SearchResult
    ...
    async def _unsafe_process(self) -> None:
        ...
        while True:
            with Measure(self.clock, "user_dir_delta"):
                ...
                relapse.metrics.event_processing_positions.labels("user_dir").set(
                    max_pos
                )
