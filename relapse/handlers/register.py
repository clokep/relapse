...
from relapse.replication.http.login import RegisterDeviceReplicationServlet
from relapse.replication.http.register import (
    ReplicationPostRegisterActionsServlet,
    ReplicationRegisterServlet,
)
from relapse.spam_checker_api import RegistrationBehaviour
from relapse.types import GUEST_USER_ID_PATTERN, RoomAlias, UserID, create_requester
...
class RegistrationHandler:
    ...
    async def check_username(
        ...
        if not localpart:
            raise RelapseError(400, "User ID cannot be empty", Codes.INVALID_USERNAME)
    ...
    async def register_user(
        ...
        Raises:
            RelapseError if there was a problem registering.
        """
        ...
        if result == RegistrationBehaviour.DENY:
            ...
            # denied.
            raise RelapseError(429, "Rate limited")
        ...
        if localpart is not None:
            ...
            while True:
                ...
                if fail_count > 10:
                    raise RelapseError(500, "Unable to find a suitable guest user ID")
