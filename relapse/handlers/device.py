...
from relapse.logging.opentracing import log_kv, set_tag, trace
from relapse.metrics.background_process_metrics import (
    run_as_background_process,
    wrap_as_background_process,
)
from relapse.storage.databases.main.client_ips import DeviceLastConnectionInfo
...
from relapse.util.retryutils import (
...
class DeviceHandler(DeviceWorkerHandler):
    ...
    def _check_device_name_length(self, name: Optional[str]) -> None:
        ...
        Raises:
            RelapseError: if the device name is too long.
        """
...
class DeviceListUpdater(DeviceListWorkerUpdater):
    ...
    async def _user_device_resync_returning_failed(
        ...
        try:
            ...
            # as otherwise relapse will 'forget' that its device list
        ...
        # inbound federation worker to the relapse master may time out
