...
from relapse.util.hash import sha256_and_url_safe_base64
from relapse.util.stringutils import (
...
class IdentityHandler:
    ...
    async def threepid_from_creds(
        ...
        try:
            ...
            raise RelapseError(500, "Timed out contacting identity server")
    ...
    async def bind_threepid(
        ...
        Raises:
            RelapseError: On any of the following conditions
    ...
    async def try_unbind_threepid(
        ...
        Raises:
            RelapseError: If we failed to contact one or more identity servers.
    ...
    async def _try_unbind_threepid_with_id_server(
        ...
        try:
            ...
            if e.code in (400, 404, 501):
                ...
                raise RelapseError(500, "Failed to contact identity server")
        except RequestTimedOutError:
            raise RelapseError(500, "Timed out contacting identity server")
    ...
    async def send_threepid_validation(
        ...
        Raises:
            RelapseError is an error occurred when sending the email
        """
        ...
        try:
            ...
            raise RelapseError(500, "An error was encountered when sending the email")
    ...
    async def proxy_msisdn_submit_token(
        ...
        Raises:
            RelapseError: If we failed to contact the identity server
        ...
        try:
            ...
            raise RelapseError(400, "Error contacting the identity server")
