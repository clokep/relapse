...
from relapse.api.errors import Codes, NotFoundError, RedirectException, RelapseError
...
class SsoIdentityProvider(Protocol):
    ...
    Relapse supports various implementations of IdPs, including OpenID Connect, SAML,
    and CAS.
...
class SsoHandler:
    ...
    def render_error(
        ...
        be found under `relapse/res/templates/sso_error.html`.
    ...
    async def handle_redirect_request(
        ...
        return "/_relapse/client/pick_idp?" + urlencode(
    ...
    async def _register_mapped_user(
        ...
        Raises:
            ...
            a RelapseError with code 400 and errcode Codes.USER_IN_USE if the localpart
            is already taken.
        """
    ...
    async def complete_sso_ui_auth_request(
        ...
        recentish relapse versions, but may not be for older users.
    ...
    def get_mapping_session(self, session_id: str) -> UsernameMappingSession:
        ...
        If it is not found, raises a RelapseError with an http code of 400
        ...
        Raises:
            RelapseError if the session is not found/has expired
        """
        ...
        raise RelapseError(400, "unknown session")
    ...
    async def check_username_availability(
        ...
        Raises:
            RelapseError if the localpart is invalid or the session is unknown
        """
