...
from relapse.storage.databases.main.room import LargestRoomStats
from relapse.types import JsonDict, JsonMapping, ThirdPartyInstanceID
from relapse.util.caches.descriptors import _CacheContext, cached
        ...
        if search_filter:
            ...
            try:
                ...
                if hre.code in (404, 405) or syn_err.errcode in (
                    ...
                    raise RelapseError(502, "Failed to fetch room list")
