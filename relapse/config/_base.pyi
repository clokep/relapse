...
from relapse.config import (  # noqa: F401
    account_validity,
    api,
    appservice,
    auth,
...
class Config:
    ...
    def __init__(self, root_config: RootConfig | None = ...) -> None: ...
    @staticmethod
...
@overload
def read_file(
    file_path: Any, config_path: Iterable[str], as_bytes: Literal[False]
) -> str: ...
@overload
def read_file(
    file_path: Any, config_path: Iterable[str], as_bytes: Literal[True]
) -> bytes: ...
