...
from relapse.util.module_loader import load_module, load_python_module
    ...
    def _default_saml_config_dict(
        ...
        Args:
            ...
            optional_attributes: SAML auth response attributes that can be used to add
                additional information to Relapse user accounts, but are not required
        ...
        metadata_url = public_baseurl + "_relapse/client/saml2/metadata.xml"
        response_url = public_baseurl + "_relapse/client/saml2/authn_response"
        return {
