...
from relapse.logging.filter import MetadataFilter
from relapse.relapse_rust import reset_logging_config
from relapse.types import JsonDict

from ..util import RELAPSE_VERSION
...
DEFAULT_LOG_CONFIG = Template(
    """\
# Log configuration for Relapse.
#
# This is a YAML file containing a standard Python logging configuration
# dictionary. See [1] for details on the valid settings.
#
# Relapse also supports structured logging for machine readable logs which can
# be ingested by ELK stacks. See [2] for details.
#
# [1]: https://docs.python.org/3/library/logging.config.html#configuration-dictionary-schema
# [2]: https://clokep.github.io/relapse/latest/structured_logging.html
...
removed in Relapse 1.3.0. You should instead set up a separate log configuration file.
"""

STRUCTURED_ERROR = """\
Support for the structured configuration option was removed in Relapse 1.54.0.
You should instead use the standard logging configuration. See
https://clokep.github.io/relapse/v1.54/structured_logging.html
"""
...
class LoggingConfig(Config):
    ...
    def generate_files(self, config: dict[str, Any], config_dir_path: str) -> None:
        ...
        if log_config and not os.path.exists(log_config):
            ...
            print(
                f"Generating log config file {log_config} which will log to {log_file}"
            )
...
def _setup_stdlib_logging(
    ...
    if log_config_path is None:
        ...
        logging.getLogger("relapse.storage.SQL").setLevel(logging.INFO)
...
def setup_logging(
    ...
    from relapse.app import _base as appbase
