...
from relapse.config.server import generate_ip_set
...
The Relapse config url_preview_ip_range_blacklist will be ignored as an HTTP(s) proxy is configured."""
    ...
    def read_config(self, config: JsonDict, **kwargs: Any) -> None:
        ...
        for i, provider_config in enumerate(storage_providers):
            ...
            if (
                ...
                or provider_config["module"] == "relapse.rest.media.v1.storage_provider"
            ):
                provider_config[
                    "module"
                ] = "relapse.media.storage_provider.FileStorageProviderBackend"
