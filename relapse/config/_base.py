...
from relapse.util.templates import _create_mxc_to_http_filter, _format_ts_filter
...
CONFIG_FILE_HEADER = """\
# Configuration file for Relapse.
#
...
#
# For more information on how to configure Relapse, including a complete accounting of
# each option, go to docs/usage/configuration/config_documentation.md or
# https://clokep.github.io/relapse/latest/usage/configuration/config_documentation.html
"""
...
class Config:
    ...
    def __init__(self, root_config: "RootConfig" = None):
        ...
        # Get the path to the default Relapse template directory
        self.default_template_dir = pkg_resources.resource_filename(
            "relapse", "res/templates"
        )
    ...
    def read_template(self, filename: str) -> jinja2.Template:
        ...
        This function will attempt to load the given template from the default Relapse
        template directory.
    ...
    def read_templates(
        ...
        Args:
            ...
            custom_template_directories: A list of directory to try to look for the
                templates before using the default Relapse template directory instead.
        ...
        # TODO: switch to relapse.util.templates.build_jinja_env
...
class RootConfig:
    ...
    def generate_config(
        ...
        Args:
            ...
            listeners: A list of descriptions of the listeners relapse should
