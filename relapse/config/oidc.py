...
class OIDCConfig(Config):
    ...
    def read_config(self, config: JsonDict, **kwargs: Any) -> None:
        ...
        # after relapse has forked so doesn't give nice errors.)
        ...
        self.oidc_callback_url = public_baseurl + "_relapse/client/oidc/callback"
...
class OidcProviderConfig:
    ...
    # Whether Relapse should ignore the `sub` claim in backchannel logouts or not.
