...
from relapse.api.auth.base import BaseAuth
...
from relapse.types import Requester, UserID, create_requester
...
introspection_response_timer = Histogram(
    "relapse_api_auth_delegated_introspection_response",
...
# Scope which allows access to the Relapse admin API
...
class MSC3861DelegatedAuth(BaseAuth):
    ...
    async def is_server_admin(self, requester: Requester) -> bool:
        return "urn:relapse:admin:*" in requester.scope
    ...
    async def get_user_by_access_token(
        ...
        try:
            ...
            raise RelapseError(503, "Unable to introspect the access token")
