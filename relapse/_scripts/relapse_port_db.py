...
from relapse.notifier import ReplicationNotifier
from relapse.storage.database import DatabasePool, LoggingTransaction, make_conn
from relapse.storage.databases.main import FilteringWorkerStore, PushRuleStore
from relapse.storage.databases.main.account_data import AccountDataWorkerStore
from relapse.storage.databases.main.client_ips import ClientIpBackgroundUpdateStore
from relapse.storage.databases.main.deviceinbox import DeviceInboxBackgroundUpdateStore
from relapse.storage.databases.main.devices import DeviceBackgroundUpdateStore
from relapse.storage.databases.main.e2e_room_keys import EndToEndRoomKeyBackgroundStore
from relapse.storage.databases.main.end_to_end_keys import EndToEndKeyBackgroundStore
from relapse.storage.databases.main.event_federation import EventFederationWorkerStore
from relapse.storage.databases.main.event_push_actions import EventPushActionsStore
from relapse.storage.databases.main.events_bg_updates import (
    EventsBackgroundUpdatesStore,
)
from relapse.storage.databases.main.media_repository import (
    MediaRepositoryBackgroundUpdateStore,
)
from relapse.storage.databases.main.presence import PresenceBackgroundUpdateStore
from relapse.storage.databases.main.profile import ProfileWorkerStore
from relapse.storage.databases.main.pusher import (
    PusherBackgroundUpdatesStore,
    PusherWorkerStore,
)
from relapse.storage.databases.main.receipts import ReceiptsBackgroundUpdateStore
...
from relapse.storage.databases.main.room import RoomBackgroundUpdateStore
from relapse.storage.databases.main.roommember import RoomMemberBackgroundUpdateStore
from relapse.storage.databases.main.search import SearchBackgroundUpdateStore
from relapse.storage.databases.main.state import MainStateBackgroundUpdateStore
...
from relapse.storage.databases.state.bg_updates import StateBackgroundUpdateStore
...
from relapse.util import RELAPSE_VERSION, Clock

# Cast safety: Twisted does some naughty magic which replaces the
# twisted.internet.reactor module with a Reactor instance at runtime.
reactor = cast(IRelapseReactor, reactor_)
logger = logging.getLogger("relapse_port_db")
...
class MockHomeserver:
    def __init__(self, config: HomeServerConfig):
        ...
        self.version_string = RELAPSE_VERSION
...
class Porter:
    ...
    async def handle_table(
        ...
        if table == "user_directory_stream_pos":
            ...
            # what relapse expects to be there.
            await self.postgres_store.db_pool.simple_insert(
    ...
    def build_db_store(
        ...
        Args:
            ...
            allow_outdated_version: True to suppress errors about the database server
                version being too old to run a complete relapse
        ...
        try:
            ...
            if await self.sqlite_store.db_pool.runInteraction(
                ...
                end_error = (
                    ...
                    " To disable auto_vacuum, you need to stop Relapse and run the following SQL:\n"
            ...
            if not updates_complete:
                end_error = (
                    ...
                    " Please start Relapse again and wait until every update has finished"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="A script to port an existing relapse SQLite database to"
    ...
    parser.add_argument(
        ...
        " currently used by a running relapse server",
    )
    parser.add_argument(
        "--postgres-config",
    ...
    logging.basicConfig(
        ...
        filename="port-relapse.log" if args.curses else None,
    )
