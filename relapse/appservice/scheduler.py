...
from relapse.types import DeviceListUpdates, JsonMapping
...
class _Recoverer:
    ...
    Args:
        clock (relapse.util.Clock):
        store (relapse.storage.DataStore):
        as_api (relapse.appservice.api.ApplicationServiceApi):
        service (relapse.appservice.ApplicationService): the service we are managing
