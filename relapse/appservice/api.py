...
from relapse.events.utils import SerializeEventConfig, serialize_event
from relapse.http.client import SimpleHttpClient, is_unknown_endpoint
from relapse.logging import opentracing
from relapse.types import DeviceListUpdates, JsonDict, JsonMapping, ThirdPartyInstanceID
...
sent_transactions_counter = Counter(
    "relapse_appservice_api_sent_transactions",
    "Number of /transactions/ requests sent",
    ["service"],
)

failed_transactions_counter = Counter(
    "relapse_appservice_api_failed_transactions",
    "Number of /transactions/ requests that failed to send",
    ["service"],
)

sent_events_counter = Counter(
    "relapse_appservice_api_sent_events", "Number of events sent to the AS", ["service"]
)

sent_ephemeral_counter = Counter(
    "relapse_appservice_api_sent_ephemeral",
    "Number of ephemeral events sent to the AS",
    ["service"],
)

sent_todevice_counter = Counter(
    "relapse_appservice_api_sent_todevice",
