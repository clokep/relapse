...
current_mau_by_service_gauge = Gauge(
    "relapse_admin_mau_current_mau_by_service",
    "Current MAU by service",
    ["app_service"],
)
max_mau_gauge = Gauge("relapse_admin_mau_max", "MAU Limit")
registered_reserved_users_mau_gauge = Gauge(
    "relapse_admin_mau_registered_reserved_users",
...
async def phone_stats_home(
    ...
    #
    relapse_logger = logging.getLogger("relapse")
    log_level = relapse_logger.getEffectiveLevel()
