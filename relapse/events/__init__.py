...
#
# NOTE: This is overridden by the configuration by the Relapse worker apps, but
# for the sake of tests, it is set here while it cannot be configured on the
# homeserver object itself.

USE_FROZEN_DICTS = strtobool(os.environ.get("RELAPSE_USE_FROZEN_DICTS", "0"))
...
class EventBase(metaclass=abc.ABCMeta):
    ...
    # TODO state_key should be Optional[str]. This is generally asserted in Relapse
