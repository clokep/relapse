...
from relapse.config.emailconfig import EmailSubjectConfig
from relapse.events import EventBase
from relapse.push.presentable_names import (
    calculate_room_name,
    descriptor_from_member_events,
    name_from_member_event,
)
from relapse.push.push_types import (
    EmailReason,
    MessageVars,
    NotifVars,
    RoomVars,
...
from relapse.types import StateMap, UserID
...
class Mailer:
    ...
    async def send_email(
        ...
        await self.send_email_handler.send_email(
            ...
            #
            # It is preferred to use email, but Relapse doesn't support incoming email.
            #
