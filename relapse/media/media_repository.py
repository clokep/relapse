...
from relapse.config.repository import ThumbnailRequirement
...
from relapse.media.storage_provider import StorageProviderWrapper
from relapse.media.thumbnailer import Thumbnailer, ThumbnailError
from relapse.media.url_previewer import UrlPreviewer
from relapse.metrics.background_process_metrics import run_as_background_process
from relapse.storage.databases.main.media_repository import LocalMedia, RemoteMedia
...
class MediaRepository:
    ...
    async def verify_can_upload(self, media_id: str, auth_user: UserID) -> None:
        ...
        * the media ID has not expired
        ...
        if media is None:
            raise RelapseError(404, "Unknow media ID", errcode=Codes.NOT_FOUND)
    ...
    def respond_not_yet_uploaded(self, request: RelapseRequest) -> None:
        respond_with_json(
            request,
            504,
    ...
    async def _download_remote_file(
        ...
        with self.media_storage.store_into_file(file_info) as (f, fname, finish):
            try:
                ...
                raise RelapseError(502, "Failed to fetch remote media")
