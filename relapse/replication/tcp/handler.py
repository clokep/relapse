...
user_ip_cache_counter = Counter("relapse_replication_tcp_resource_user_ip_cache", "")
...
class ReplicationCommandHandler:
    ...
    def start_replication(self, hs: "HomeServer") -> None:
        ...
        from relapse.replication.tcp.redis import RedisDirectTcpReplicationClientFactory
