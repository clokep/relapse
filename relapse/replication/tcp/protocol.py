...
connection_close_counter = Counter(
    "relapse_replication_tcp_protocol_close_reason", "", ["reason_type"]
)
...
pending_commands = LaterGauge(
    "relapse_replication_tcp_protocol_pending_commands",
    "",
    ["name"],
...
transport_send_buffer = LaterGauge(
    "relapse_replication_tcp_protocol_transport_send_buffer",
    "",
    ["name"],
...
tcp_transport_kernel_send_buffer = LaterGauge(
    "relapse_replication_tcp_protocol_transport_kernel_send_buffer",
    "",
    ["name"],
    lambda: {
...
tcp_transport_kernel_read_buffer = LaterGauge(
    "relapse_replication_tcp_protocol_transport_kernel_read_buffer",
    "",
    ["name"],
    lambda: {
