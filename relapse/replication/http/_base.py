...
from relapse.api.errors import HttpResponseException, RelapseError
from relapse.config.workers import MAIN_PROCESS_INSTANCE_NAME
...
class ReplicationEndpoint(metaclass=abc.ABCMeta):
    ...
    This creates an endpoint under `/_relapse/replication/:NAME/:PATH_ARGS..`
    ...
    with `CACHE` set to true then this generates an endpoint:
        ...
        /_relapse/replication/send_event/:event_id/:txn_id
            ...
            *, instance_name: str = MAIN_PROCESS_INSTANCE_NAME, **kwargs: Any
            ...
            with outgoing_gauge.track_inprogress():
                ...
                try:
                    ...
                    # We convert to RelapseError as we know that it was a RelapseError
