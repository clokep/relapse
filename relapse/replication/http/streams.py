...
from relapse.http.servlet import parse_integer
...
class ReplicationGetStreamUpdates(ReplicationEndpoint):
    ...
    The API looks like:
        ...
        GET /_relapse/replication/get_repl_stream_updates/<stream name>?from_token=0&to_token=10
    ...
    async def _handle_request(  # type: ignore[override]
        ...
        if stream is None:
            raise RelapseError(400, "Unknown stream")
