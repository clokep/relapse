...
class ReplicationFederationSendEventsRestServlet(ReplicationEndpoint):
    ...
    The API looks like:
        ...
        POST /_relapse/replication/fed_send_events/:txn_id
...
class ReplicationFederationSendEduRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_relapse/replication/fed_send_edu/:edu_type/:txn_id
...
class ReplicationGetQueryRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_relapse/replication/fed_query/:query_type
...
class ReplicationCleanRoomRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_relapse/replication/fed_cleanup_room/:room_id/:txn_id
...
class ReplicationStoreRoomOnOutlierMembershipRestServlet(ReplicationEndpoint):
    ...
    Request format:
        ...
        POST /_relapse/replication/store_room_on_outlier_membership/:room_id/:txn_id
