...
from relapse.federation.persistence import TransactionActions
...
from relapse.storage.databases.main.lock import Lock
from relapse.storage.databases.main.roommember import extract_heroes_from_room_summary
from relapse.storage.roommember import MemberSummary
from relapse.types import JsonDict, StateMap, UserID, get_domain_from_id
from relapse.util import unwrapFirstError
from relapse.util.async_helpers import Linearizer, concurrently_execute, gather_results
from relapse.util.caches.response_cache import ResponseCache
...
received_pdus_counter = Counter("relapse_federation_server_received_pdus", "")

received_edus_counter = Counter("relapse_federation_server_received_edus", "")

received_queries_counter = Counter(
    "relapse_federation_server_received_queries", "", ["type"]
)

pdu_process_time = Histogram(
    "relapse_federation_server_pdu_process_time",
    "Time taken to process an event",
)

last_pdu_ts_metric = Gauge(
    "relapse_federation_last_received_pdu_time",
...
class FederationServer(FederationBase):
    ...
    async def on_send_join_request(
        ...
        set_tag(
            RelapseTags.SEND_JOIN_RESPONSE_IS_PARTIAL_STATE,
    ...
    async def _on_send_membership_event(
        ...
        Raises:
            RelapseError if there is a problem with the request, including things like
    ...
    async def on_claim_client_keys(
        ...
        if any(
            ...
            raise RelapseError(400, "User is not hosted on this homeserver")
