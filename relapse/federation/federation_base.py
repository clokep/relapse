...
from relapse.crypto.event_signing import check_event_content_hash
from relapse.crypto.keyring import Keyring
from relapse.events import EventBase, make_event_from_dict
from relapse.events.utils import prune_event, validate_canonicaljson
...
def event_from_pdu_json(pdu_json: JsonDict, room_version: RoomVersion) -> EventBase:
    ...
    Raises:
        RelapseError: if the pdu is missing required fields or is otherwise
    ...
    if depth < 0:
        ...
        raise RelapseError(400, "Depth too large", Codes.BAD_JSON)
