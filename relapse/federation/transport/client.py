...
from relapse.api.constants import Direction, Membership
...
from relapse.http.matrixfederationclient import ByteParser, LegacyJsonSendParser
...
if TYPE_CHECKING:
    from relapse.app.homeserver import HomeServer
...
class TransportLayerClient:
    ...
    async def get_public_rooms(
        ...
        See relapse.federation.federation_client.FederationClient.get_public_rooms for
        more information.
        """
