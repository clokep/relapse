...
from relapse.logging.opentracing import RelapseTags, set_tag
from relapse.metrics import sent_transactions_counter
...
sent_edus_counter = Counter(
    "relapse_federation_client_sent_edus", "Total number of EDUs successfully sent"
)

sent_edus_by_type = Counter(
    "relapse_federation_client_sent_edus_by_type",
...
class PerDestinationQueue:
    ...
    def __init__(
        ...
        transaction_manager: "relapse.federation.sender.TransactionManager",
        destination: str,
    ):
    ...
    async def _get_to_device_message_edus(self, limit: int) -> tuple[list[Edu], int]:
        ...
        for content in contents:
            ...
            set_tag(RelapseTags.TO_DEVICE_EDU_ID, message_id)
