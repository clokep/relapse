...
from relapse.events.presence_router import (
    GET_INTERESTED_USERS_CALLBACK,
    GET_USERS_FOR_STATES_CALLBACK,
    PresenceRouter,
)
from relapse.events.utils import ADD_EXTRA_FIELDS_TO_UNSIGNED_CLIENT_EVENT_CALLBACK
from relapse.handlers.account_data import ON_ACCOUNT_DATA_UPDATED_CALLBACK
from relapse.handlers.auth import (
...
from relapse.push.httppusher import HttpPusher
...
from relapse.storage.database import DatabasePool, LoggingTransaction
from relapse.storage.databases.main.roommember import ProfileInfo
...
from relapse.util.caches.descriptors import CachedFunction, cached as _cached
from relapse.util.frozenutils import freeze

if TYPE_CHECKING:
    from relapse.app.generic_worker import GenericWorkerStore
...
class ModuleApi:
    ...
    def http_client(self) -> SimpleHttpClient:
        ...
        An instance of relapse.http.client.SimpleHttpClient

        Added in Relapse v1.22.0.
        """
    ...
    def public_room_list_manager(self) -> "PublicRoomListManager":
        ...
        An instance of relapse.module_api.PublicRoomListManager
    ...
    def register_user(
        ...
        Changed in Relapse v1.56.0: add 'admin' argument to register the user as admin.
        ...
        Raises:
            RelapseError if there is an error performing the registration. Check the
    ...
    async def update_room_membership(
        ...
        Added in Relapse v1.46.0.
        Changed in Relapse v1.65.0: Added the 'remote_room_hosts' parameter.
        ...
        Raises:
            ...
            RelapseError if the module attempts to send a membership event that isn't
    ...
    async def create_and_send_event_into_room(self, event_dict: JsonDict) -> EventBase:
        ...
        Raises:
            RelapseError if the event was not allowed.
        """
        ...
        **kwargs: object,
        ...
        Args:
            f: The function to call repeatedly. f can be either synchronous or
                asynchronous, and must follow Relapse's logcontext rules.
                More info about logcontexts is available at
                https://clokep.github.io/relapse/latest/log_contexts.html
    ...
    def delayed_background_call(
        ...
        **kwargs: object,
        ...
        The scheduled call is not persistent: if the current Relapse instance is
        restarted before the call is made, the call will not be made.

        Added in Relapse v1.90.0.
    ...
    def read_templates(
        ...
        By default, Relapse will look for these templates in its configured template
    ...
    async def defer_to_thread(
        ...
        **kwargs: P.kwargs,
        ...
        """Runs the given function in a separate thread from Relapse's thread pool.
    ...
    async def check_username(self, username: str) -> None:
        ...
        Raises:
            RelapseError with the errcode "M_USER_IN_USE" if the username is already in
            use.
        """
    ...
    async def store_remote_3pid_association(
        ...
        Args:
            ...
            id_server: The identity server the 3PID association has been registered on.
                ...
                identity server using HTTPS (unless specified otherwise by Relapse's
    ...
    def check_push_rule_actions(
        ...
        Added in Relapse v1.58.0.

        Args:
            actions: the actions to check.

        Raises:
            relapse.module_api.errors.InvalidRuleException if the actions are invalid.
        """
    ...
    async def set_push_rule_action(
        ...
        Raises:
            ...
            relapse.module_api.errors.RuleNotFoundException if the rule being modified
                can't be found.
            relapse.module_api.errors.InvalidRuleException if the actions are invalid.
        """
    ...
    async def lookup_room_alias(self, room_alias: str) -> Tuple[str, List[str]]:
        ...
        Raises:
            RelapseError if room alias is invalid or could not be found.
        """
    ...
    async def create_room(
        ...
        Raises:
            ...
            RelapseError if the user_id is invalid, room ID couldn't be stored, or
    ...
    async def delete_room(self, room_id: str) -> None:
        """
        Schedules the deletion of a room from Relapse's database.
