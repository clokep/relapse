...
from relapse.api.errors import ModuleFailedException, RelapseError
    ...
    async def check_event_allowed(
        ...
        for callback in self._check_event_allowed_callbacks:
            try:
                ...
                # FIXME: Being able to throw RelapseErrors is relied upon by
    ...
    async def on_create_room(
        ...
        for callback in self._on_create_room_callbacks:
            try:
                ...
                # it's a RelapseError we can send to clients.
                if not isinstance(e, RelapseError):
                    e = RelapseError(
