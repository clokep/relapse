...
from relapse.api.errors import Codes, InvalidProxyCredentialsError
from relapse.http import QuieterFileBodyProducer
from relapse.http.server import _AsyncResource
...
class ProxyResource(_AsyncResource):
    ...
    def __init__(self, reactor: IRelapseReactor, hs: "HomeServer"):
        super().__init__(True)
...
class ProxySite(Site):
    ...
    def getResourceFor(self, request: "RelapseRequest") -> IResource:
        uri = urllib.parse.urlparse(request.uri)
