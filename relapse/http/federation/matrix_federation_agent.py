...
from relapse.http import proxyagent
from relapse.http.client import BlocklistingAgentWrapper, BlocklistingReactorWrapper
from relapse.http.connectproxyclient import HTTPConnectProxyEndpoint
from relapse.http.federation.srv_resolver import Server, SrvResolver
from relapse.http.federation.well_known_resolver import WellKnownResolver
...
class MatrixFederationAgent:
    ...
    Relapse and we purposely want to avoid colliding with the `matrix://` URL scheme
