...
from relapse.logging.context import current_context
...
response_count = Counter(
    "relapse_http_server_response_count", "", ["method", "servlet", "tag"]
)

requests_counter = Counter(
    "relapse_http_server_requests_received", "", ["method", "servlet"]
)

outgoing_responses_counter = Counter(
    "relapse_http_server_responses", "", ["method", "code"]
)
...
response_ru_utime = Counter(
    "relapse_http_server_response_ru_utime_seconds", "sec", ["method", "servlet", "tag"]
)

response_ru_stime = Counter(
    "relapse_http_server_response_ru_stime_seconds", "sec", ["method", "servlet", "tag"]
)

response_db_txn_count = Counter(
    "relapse_http_server_response_db_txn_count", "", ["method", "servlet", "tag"]
)

# seconds spent waiting for db txns, excluding scheduling time, when processing
# this request
response_db_txn_duration = Counter(
    "relapse_http_server_response_db_txn_duration_seconds",
    "",
    ["method", "servlet", "tag"],
)
...
response_db_sched_duration = Counter(
    "relapse_http_server_response_db_sched_duration_seconds",
    "",
    ["method", "servlet", "tag"],
)
...
response_size = Counter(
    "relapse_http_server_response_size", "", ["method", "servlet", "tag"]
)
...
in_flight_requests_ru_utime = Counter(
    "relapse_http_server_in_flight_requests_ru_utime_seconds", "", ["method", "servlet"]
)

in_flight_requests_ru_stime = Counter(
    "relapse_http_server_in_flight_requests_ru_stime_seconds", "", ["method", "servlet"]
)

in_flight_requests_db_txn_count = Counter(
    "relapse_http_server_in_flight_requests_db_txn_count", "", ["method", "servlet"]
)

# seconds spent waiting for db txns, excluding scheduling time, when processing
# this request
in_flight_requests_db_txn_duration = Counter(
    "relapse_http_server_in_flight_requests_db_txn_duration_seconds",
    "",
    ["method", "servlet"],
)
...
in_flight_requests_db_sched_duration = Counter(
    "relapse_http_server_in_flight_requests_db_sched_duration_seconds",
    "",
    ["method", "servlet"],
)
...
LaterGauge(
    "relapse_http_server_in_flight_requests_count",
    "",
    ["method", "servlet"],
