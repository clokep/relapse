...
from relapse.handlers.sync import (
    ArchivedSyncResult,
    InvitedSyncResult,
    JoinedSyncResult,
    KnockedSyncResult,
...
from relapse.types import JsonDict, Requester, StreamToken
...
class SyncRestServlet(RestServlet):
    ...
    async def on_GET(self, request: RelapseRequest) -> tuple[int, JsonDict]:
        ...
        if filter_id is None:
            ...
            try:
                ...
                raise RelapseError(400, "Invalid filter JSON", errcode=Codes.NOT_JSON)
            ...
            try:
                ...
                raise RelapseError(400, "No such filter", errcode=Codes.INVALID_PARAM)
    ...
    async def encode_response(
        ...
        # Corresponding relapse issue: https://github.com/matrix-org/synapse/issues/10456
