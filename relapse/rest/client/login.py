...
from relapse.api.constants import ApprovalNoticeMedium
...
from relapse.http.site import RelapseRequest, RequestInfo
from relapse.rest.client._base import client_patterns
from relapse.rest.well_known import WellKnownBuilder
...
class LoginRestServlet(RestServlet):
    ...
    def on_GET(self, request: RelapseRequest) -> Tuple[int, JsonDict]:
        ...
        # relapse currently only gives out these tokens as part of the
    ...
    async def on_POST(self, request: RelapseRequest) -> Tuple[int, LoginResponse]:
        ...
        try:
            ...
            raise RelapseError(400, "Missing JSON keys.")
    ...
    async def _do_appservice_login(
        ...
        *,
        ...
        if not isinstance(user, str):
            raise RelapseError(400, "Invalid user in identifier", Codes.INVALID_PARAM)
        ...
        return await self._complete_login(
            ...
            # is not actually created in Relapse.
...
class RefreshTokenServlet(RestServlet):
    ...
    async def on_POST(self, request: RelapseRequest) -> Tuple[int, JsonDict]:
        ...
        if not isinstance(token, str):
            raise RelapseError(400, "Invalid param: refresh_token", Codes.INVALID_PARAM)
...
class CasTicketServlet(RestServlet):
    ...
    async def on_GET(self, request: RelapseRequest) -> None:
        ...
        if not client_redirect_url and not session:
            ...
            raise RelapseError(400, message, errcode=Codes.MISSING_PARAM)
