...
from relapse.http.server import HttpServer, respond_with_redirect
...
class RendezvousServlet(RestServlet):
    ...
    A module that implements the full functionality is available at: https://pypi.org/project/matrix-http-rendezvous-relapse/.
