...
from relapse.rest.admin.background_updates import (
    BackgroundUpdateEnabledRestServlet,
    BackgroundUpdateRestServlet,
    BackgroundUpdateStartJobRestServlet,
)
from relapse.rest.admin.devices import (
    DeleteDevicesRestServlet,
    DeviceRestServlet,
    DevicesRestServlet,
)
from relapse.rest.admin.event_reports import (
    EventReportDetailRestServlet,
    EventReportsRestServlet,
)
from relapse.rest.admin.experimental_features import ExperimentalFeaturesRestServlet
from relapse.rest.admin.federation import (
    DestinationMembershipRestServlet,
    DestinationResetConnectionRestServlet,
    DestinationRestServlet,
    ListDestinationsRestServlet,
)
from relapse.rest.admin.media import ListMediaInRoom, register_servlets_for_media_repo
from relapse.rest.admin.registration_tokens import (
    ListRegistrationTokensRestServlet,
    NewRegistrationTokenRestServlet,
    RegistrationTokenRestServlet,
)
from relapse.rest.admin.rooms import (
...
from relapse.rest.admin.server_notice_servlet import SendServerNoticeServlet
from relapse.rest.admin.statistics import (
    LargestRoomsStatistics,
    UserMediaStatisticsRestServlet,
)
from relapse.rest.admin.username_available import UsernameAvailableRestServlet
from relapse.rest.admin.users import (
    ...
    async def on_POST(
        ...
        if event_id is not None:
            ...
            if event.room_id != room_id:
                raise RelapseError(HTTPStatus.BAD_REQUEST, "Event is for wrong room.")
