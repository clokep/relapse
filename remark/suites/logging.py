...
from relapse.config.logger import _setup_stdlib_logging
...
async def main(reactor: IRelapseReactor, loops: int) -> float:
    """
    ...
    log_config = {
        "version": 1,
        "loggers": {"relapse": {"level": "DEBUG", "handlers": ["remote"]}},
        "formatters": {"tersejson": {"class": "relapse.logging.TerseJsonFormatter"}},
        "handlers": {
            "remote": {
    ...
    logger = logging.getLogger("relapse")
    ...
    for handler in logging.getLogger("relapse").handlers:
